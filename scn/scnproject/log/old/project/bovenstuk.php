          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbar-collapse-main">
                <ul class="nav navbar-nav navbar-right">
                  <li><a href="home.php"><span class="glyphicon glyphicon-home" style="font-size:13px"></span> Home</a></li>
                  <li><a href="upload.php"><span class="glyphicon glyphicon-upload" style="font-size:13px"></span> Uploaden</a></li>
                  <li><a href="login.php"><span class="glyphicon glyphicon-log-in" style="font-size:13px;"></span> Inloggen</a></li>
                  <li><a href="register.php"><span class="glyphicon glyphicon-user" style="font-size:13px"></span>  Registreren</a></li>
                </ul>
            </div>
          </div>
        </nav>
